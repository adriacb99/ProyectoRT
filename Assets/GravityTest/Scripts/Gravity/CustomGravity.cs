...
public class CustomGravity : MonoBehaviour
{
    ...
    {
        rb.AddForce(-currentNormal * gravityPower * Time.deltaTime, ForceMode.Acceleration); //Gravedad, lo tira hacia el planeta (si quitas el icono negativo se va para arriba)
    }
    ...
    void CheckForGravityDir()
    {
        ...
        if (hitSuccess)
        {
            ...
            var lastSurfacePos = hitInfo.point;
        }
